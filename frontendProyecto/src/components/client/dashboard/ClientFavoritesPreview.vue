...
.favorites-card {
  ...
  border-radius: 12px;
  box-shadow: 0 10px 26px rgba(7, 27, 28, 0.08);
  padding: 18px;
}
.card-head { margin-bottom: 12px; }
.card-head p { margin: 0 0 4px; color: var(--color-brass); font-size: 12px; font-weight: 800; letter-spacing: .12em; text-transform: uppercase; }
.card-head h2 { margin: 0; color: var(--color-petrol); font-size: 18px; }
...
.fav-item:hover { border-color: var(--color-brass); background: var(--color-card); }
.fav-thumb {
  width: 52px;
  height: 52px;
  border-radius: 8px;
...
.fav-info .city { color: var(--color-brass); font-size: 10px; font-weight: 800; letter-spacing: .1em; text-transform: uppercase; }
.fav-info strong {
...
.fav-info .price { color: var(--color-ink); font-weight: 700; font-size: 13px; }
