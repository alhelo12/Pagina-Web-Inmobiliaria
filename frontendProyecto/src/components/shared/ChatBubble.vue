...
.sender-name { font-size: 11px; font-weight: 700; color: var(--color-muted); margin: 0 4px 4px; }
.sender-name-mine { color: var(--color-brass-ink); text-align: right; }
...
.message-status { font-size: 11px; color: var(--color-brass-ink); font-weight: 700; }
