...
<style scoped>
.chart-card { background: var(--color-card); border: 1px solid var(--color-line); border-radius: 12px; box-shadow: 0 10px 26px rgba(7, 27, 28, 0.08); padding: 18px; }
h2 { margin: 0 0 16px; color: var(--color-petrol); font-weight: 700; }
...
.bar { width: 36px; border-radius: 12px 10px 6px 6px; background: var(--color-brass); transition: .2s; }
.bar:hover { filter: brightness(1.08); }
small { display: block; margin-top: 8px; color: var(--color-muted); overflow-wrap: anywhere; }
strong { color: var(--color-petrol); font-size: 13px; }
