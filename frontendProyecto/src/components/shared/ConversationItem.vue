...
.conv-avatar { width: 44px; height: 44px; border-radius: 50%; background: var(--color-brass); color: white; display: flex; align-items: center; justify-content: center; font-weight: 700; font-size: 16px; flex-shrink: 0; }
...
.conv-name { font-weight: 600; color: var(--color-petrol); font-size: 14px; }
...
.unread-badge { background: var(--color-brass); color: white; font-size: 11px; font-weight: 700; min-width: 20px; height: 20px; border-radius: 12px; display: flex; align-items: center; justify-content: center; padding: 0 6px; flex-shrink: 0; }
