    ...
    <div class="section-header">
      <div class="filters">
        <button
          ...
          :key="filter.key"
          :class="['filter-btn', { active: activeFilter === filter.key }]" :aria-pressed="activeFilter === filter.key"
      ...
      <div class="header-actions-row">
        ...
        <button class="prefs-btn" title="Preferencias" aria-label="Preferencias de notificación" @click="showPreferences = true">
